...
const Banner = () => {
    ...
    return (
        <div >
            <div className="bg-[#050a18] h-[100%] w-[100%] flex lg:flex-row flex-col">

                <div className="basis-2/3 border-b-2 border-l-2 border-[rgb(255,255,255,0.1)]  ">
                    <div className="text-center font-josef text-[15vh] mt-6 text-white">
                        <p>ALI ASHRAF ABIR</p>
                    </div>
                    <TypeAnimation
                        sequence={[
                    ...
                    <div className=" font-nunito text-[3vh] lg:text-[4vh] mt-6">
                        <p>
